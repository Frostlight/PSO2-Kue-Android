 ...
 * on 2017-01-06 at 15:30:47 UTC 
 * Modify at your own risk.
 */

package frostlight.pso2kue.backend.registration;
...
public class Registration extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @since 1.7
   */
  public static final String DEFAULT_ROOT_URL = "https://pso2-kue.appspot.com/_ah/api/";
  ...
  public class ListDevices extends RegistrationRequest<frostlight.pso2kue.backend.registration.model.CollectionResponseRegistrationRecord> {
    ...
    protected ListDevices(java.lang.Integer count) {
      super(Registration.this, "GET", REST_PATH, null, frostlight.pso2kue.backend.registration.model.CollectionResponseRegistrationRecord.class);
   ...
   * @return the request
   */
  public Register register(java.lang.String regId, java.lang.String ship) throws java.io.IOException {
    Register result = new Register(regId, ship);
    initialize(result);
    return result;
  }
  ...
  public class Register extends RegistrationRequest<Void> {
    ...
    private static final String REST_PATH = "registerDevice/{regId}/{ship}";
     ...
     * @since 1.13
     */
    protected Register(java.lang.String regId, java.lang.String ship) {
      ...
      this.ship = com.google.api.client.util.Preconditions.checkNotNull(ship, "Required parameter ship must be specified.");
    }
    ...
    public Register setShip(java.lang.String ship) {
      this.ship = ship;
      return this;
    }
